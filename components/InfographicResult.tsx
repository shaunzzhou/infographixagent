    ...
    <div className="flex flex-col lg:flex-row h-full gap-4 lg:gap-6 pb-4 lg:pb-0">
        ...
        <div className="w-full lg:w-[400px] xl:w-[450px] bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 flex flex-col h-auto lg:h-full flex-none transition-colors">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar">
                ...
                {/* Layout Plan (debug/visibility) */}
                {planText && (
                  <div className="bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800 rounded-lg p-3">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase">Layout Plan (for verification)</span>
                      <button
                    ...
                    {showPlan && (
                      <pre className="mt-2 whitespace-pre-wrap text-xs text-gray-700 dark:text-gray-200 max-h-64 overflow-y-auto bg-white dark:bg-slate-900 p-3 rounded border border-gray-200 dark:border-slate-800">
                        {planText}
                      </pre>
                    )}
                  </div>
                            ...
                            {AVAILABLE_TEMPLATES.map((template) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-3 px-3 py-2 rounded-md text-xs font-bold border transition-all text-left
                                            ${isSelected 
                                                ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' 
                                                : 'border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 text-gray-600 dark:text-gray-300 hover:border-gray-300 dark:hover:border-slate-600'
                                            }
